...
@present-Park 
1
00present-Park/bsms222_144_park
 Code Issues 0 Pull requests 0 Projects 0 Wiki Security Insights Settings
bsms222_144_park/Chapter_9_20190930_144_Park.Rmd
@present-Park present-Park update
d8f26ac 10 minutes ago
779 lines (535 sloc)  43.2 KB
...
F(72=) 0.841, etc.. In fact, we can report the proportion of values between any two heights, say  
a and b, by computing  F(a)-F(b)
...
First let’s define the theoretical quantiles for the normal distribution. In statistics books we use the symbol  Φ(x) to define the function that gives us the probability od a standard normal distribution being smaller than x. So, for example, Φ(-1.96)=0.025 and Φ(1.96)=0.975. In R, we can evaluate Φ using the pnorm function:
```{r}
pnorm(-1.96)
```
...
he idea of a QQ-plot is that if your data is well approximated by normal distribution then the quantiles of your data should be similar to the quantiles of a normal distribution. To construct a QQ-plot, we do the following:
...
3.fine a vector of theoretical quantiles for the proportions p1,...,pm for a normal distribution with the same average and standard deviation as the data.
...
library(ggplot2)
qplot(theoretical_quantiles, sample_quatiles) + geom_abline()
```
