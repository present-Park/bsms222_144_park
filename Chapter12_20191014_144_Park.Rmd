...
In R, points falling outside the whiskers of the boxplot are referred to as outliers. This definition of outlier was introduced by Tukey. The top whisker ends at the 75th percentile plus 1.5X IQR. Similarly the bottom whisker ends at the 25th percentile minus 1.5XIQR. If we define the first and third quartiles as Q1 and Q3, respectively, then an outlier is anything outside the range:
[Q1-1.5x(Q3-Q1), Q3+1.5x(Q3-Q1)]
